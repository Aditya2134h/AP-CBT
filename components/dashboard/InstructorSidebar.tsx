...
export function InstructorSidebar({ open, onClose }: InstructorSidebarProps) {
  const pathname = usePathname();

  const navigation = [
    { name: 'Dashboard', href: '/instructor/dashboard', icon: 'dashboard' },
    { name: 'Tests', href: '/instructor/tests', icon: 'test' },
    { name: 'Grading', href: '/instructor/grading', icon: 'grading' },
    { name: 'Analytics', href: '/instructor/analytics', icon: 'analytics' },
    { name: 'Students', href: '/instructor/students', icon: 'students' },
  ];
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-white dark:bg-gray-800 pt-5 pb-4">
                ...
                <div className="flex flex-shrink-0 items-center px-4">
                  <h1 className="text-xl font-bold text-gray-900 dark:text-white">CBT Instructor</h1>
                </div>
